...
export const useProjectsStore = defineStore('projects', () => {
  ...
  /**
   * Duplicate a project — creates a copy with a new id and "(Copie)" suffix.
   * Returns the new project.
   */
  function duplicate(id: string): SavedProject | null {
    ...
    // Update the spec's metadata to reflect the copy
    copy.spec.meta.projectName = copy.name
